...
After completing windows setup then run windows command line (cmd)
  cd daemon
  Radioactivecoind
You would need to create a configuration file Radioactivecoin.conf in the default
wallet directory. Grant access to Radioactivecoind.exe in anti-virus and firewall
...
Radioactivecoind backupwallet <destination_backup_file>
Then shutdown ppcoind by
Radioactivecoind stop
Start up the new Radioactivecoind (0.3.0).
