...
unsigned int nStakeTargetSpacing = 180; //  32 second block spacing
int64 nChainStartTime = 1389196388;
...
const string strMessageMagic = "Radioactivecoin Signed Message:\n";
...
// Radioactivecoin: increasing Nfactor gradually
...
int64 GetProofOfWorkReward( int nHeight, uint256 prevHash)
{
        ...
        if(nHeight < 1000)  
            ...
            cseed_str = prevHash.ToString().substr(5,7);
                ...
                seed = hex2long(cseed);
                rand1 = generateMTRandom(seed, 1000);
                if(rand1 < 100)
                nSubsidy = rand + 100 * COIN;
                else if(rand1 > 100)
                nSubsidy = rand1 * COIN;  
            }
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Radioactivecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
  ...
  //vMerkleTree: 05b4eb8ba8 
        ...
        // Genesis block
        const char* pszTimestamp = "Radioactivecoin to the Moon";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xdbc965076bdce758a6ccf0ab87ec019a2bc3e559fb6486db7c59bb8ecb0f2f58"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd9, 0xf6, 0xe7, 0xd5 };
